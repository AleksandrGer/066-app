const user = {
    ...
    about: "Тут мой рассказ",
};

// const users = {
//     0: {name: "Юлия", lastname: "Тетерина", id: 24, email: "julia@mail.ru",
//     avatar:
...
//     1: {name: "Константин", lastname: "Петров", id: 47, email: "akonst@konst.ru",
//     avatar:
...
//     2: {name: "Ксения", lastname: "Добрая", id: 32, email: "ksen@mail.ru",
//     avatar:
...
//     3: {name: "Диана", lastname: "Смирнова", id: 12,
//     email: "dian@ya.ru",
//     avatar:
...
//     4: {name: "Катерина", lastname: "Весенина", id: 4,
//     email: "kate@ogo.ru",
//     avatar:
...
export async function getUsers() {
    let response = await fetch ("https://brenn.lh1.in/getUsers");
